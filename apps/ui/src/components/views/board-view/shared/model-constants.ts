...
/**
 * Z.ai GLM models
 * Models from https://docs.z.ai/devpack/tool/roo
 */
export const ZAI_MODELS: ModelOption[] = [
  {
    id: 'glm-4.7',
    label: 'GLM 4.7',
    description: 'Latest Z.ai model with advanced reasoning capabilities.',
    badge: 'Latest',
    provider: 'zai',
  },
  {
...
/**
 * All available models (Claude + Cursor + Codex + OpenCode + Z.ai)
 */
