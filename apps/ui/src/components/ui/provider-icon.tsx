...
const PROVIDER_ICON_DEFINITIONS: Record<ProviderIconKey, ProviderIconDefinition> = {
  ...
  zai: {
    viewBox: '0 0 24 24',
    // Z.ai logo - stylized "Z" letter
    path: 'M4 4h16l-12 14h12v2H4l12-14H4V4z',
  },
};
...
export function ZaiIcon(props: Omit<ProviderIconProps, 'provider'>) {
  return <ProviderIcon provider={PROVIDER_ICON_KEYS.zai} {...props} />;
}
...
function getUnderlyingModelIcon(model?: AgentModel | string): ProviderIconKey {
  ...
  // Check for Z.ai models
  if (modelStr.includes('glm') || modelStr.includes('zai')) {
    return 'zai';
  }
