...
This version of Automaker includes full integration with **Z.ai's GLM models**, enabling AI-powered development workflows using GLM 4.7 and other models.

### Quick Start with Z.ai

1. Get your Z.ai API key from [z.ai](https://z.ai)
2. Set your API key in Settings > Providers > Z.ai
3. Select Z.ai as your active profile
4. Start using GLM models in Agent Runner

### Documentation

- [Z.AI-INTEGRATION.md](./Z.AI-INTEGRATION.md) - Complete setup and usage guide
- [CHANGELOG-ZAI.md](./CHANGELOG-ZAI.md) - Detailed changelog of Z.ai integration

### Supported Models

| Model | Description |
|-------|-------------|
| GLM 4.7 | Latest model with advanced reasoning |
| GLM 4 Plus | High capability model |
| GLM 4 Flash | Fast, efficient model |
| GLM 4 Long | Extended context (1M tokens) |
| GLM 4 Air | Lightweight, cost-effective |

### API Endpoints

Supports both Z.ai subscription types:
