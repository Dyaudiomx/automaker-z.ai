...
/**
 * Combined model type including Claude and Z.ai models
 */
 ...
 */
export type AgentModel = ModelAlias | CodexModelId | (typeof ZAI_MODEL_MAP)[keyof typeof ZAI_MODEL_MAP];
